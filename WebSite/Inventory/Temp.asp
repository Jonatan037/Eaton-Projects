...
<%
	...
	If strPartNumber = "" Then
		...
		Response.Write "<form method='POST' action='Temp.Asp'>"
...
Sub GetRecord()
	...
	Query = "SELECT [Item], [Alt Item], [Line], [Rack], [Overflow], [Notes]  " & _
            "FROM Inventory WHERE Item Like '" & strPartNumber & "%' " & _
		 	 "ORDER BY Item"

	Query = "Select * From [get raw materials onhand]"
	'--------------------------------------------------------------------------------------------------------
    ...
    Application("PRMS_Database")= _
	"UID=ETGINQ;" & _
	"PWD=KY9AG;" & _
	"DSN=CA32;"

	Set Conn2 = Server.CreateObject("ADODB.Connection")
	Conn2.Open Application("PRMS_Database")
