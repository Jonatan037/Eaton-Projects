...
'Time based query.
Sql = "SELECT INDEXID, Plant, Family, Category, PartNumber, SerialNumber, StartTime, Sequence, TestResult, Description, [Record Type], TestStep AS [Test Step That Failed], ResultsData, ProgramName, Info2Item, Info3Item " & _
...
If Request("SearchCriteria") <> "" Then
	...
	Sql = "SELECT INDEXID, Family, Category, PartNumber, SerialNumber, StartTime, Sequence, TestResult, Description, [Record Type], TestStep AS [Test Step That Failed], ResultsData, ProgramName " & _
		  "FROM qdms_index_view " & _
