...
QueryEndDate   = CDate(Request("QueryEndDate") ) + 1
...
'Allow selection by family name.
If sPartNumber = "9390" Then
	Sql = "SELECT I.DBID, I.PartNumber, I.SerialNumber, I.Sequence, I.StartTime, I.TestResult, I.ComputerName, I.ResultsID, P.Family, I.Info7Item, I.Info10Item " & _
      		"FROM qdms_master_index AS I INNER JOIN qdms_part_numbers AS P ON I.PartNumber = P.PartNumber " & _
      		"WHERE " & _
         	"I.RecordType = 2 AND I.DBID = 2 AND P.Family Like '" & sPartNumber & "%' AND " & _
         	"StartTime BETWEEN " & QueryStartDate & " AND " & QueryEndDate
End If
...
Response.Write "Info7Item" & chr(9)
Response.Write "Info10Item" & chr(9)
	...
	With rsTestResults
		...
		Do Until .EOF
			...
			If blnGetData Then
				...
				'Temporary
				Response.Write rsIndex("Info7Item") & chr(9)
				Response.Write rsIndex("Info10Item") & chr(9)
