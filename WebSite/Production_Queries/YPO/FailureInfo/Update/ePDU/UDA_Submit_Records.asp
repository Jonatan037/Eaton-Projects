...
<%
   ...
   strConn = "DRIVER=Microsoft Access Driver (*.mdb);UID=;PWD=;FIL=MS Access;DBQ=\\youncsfp01\data\test-eng\ePDU\Database\ePDU_Production_Master.mdb"
   Conn.Open strConn

   Response.Write strConn & "<br><br><br>"
