...
'Const sProcedureLocation = "F:\ePDU\TestProc\"
Const sProcedureLocation = "\\youncwypotest93\externaldrive\ePDU\TestProc\"
...
'Response.Write "<h2 align='center'>Note that the procedures shown below are uncontrolled.</h2>"
...
Response.Write "<h2 align='center'>Check Enovia for the lastest copy of the test procedure.</h2>"
	...
	Else
		...
		Do While Not RS.EOF
			...
			Response.Write "<tr>"
				...
				Response.Write "<td>" & RS("AssemblyNumber") & "</td>"
...
'	subFolder = sProcedureLocation & "Assemblies\" & subFolder
	subFolder = sProcedureLocation  & subFolder
	...
	'Default value for when the procedure cannot be located on the local drive.
	If sLinks = "" THEN sLinks = "Check Enovia"
