...
Set rsIndex = cnYPO.Execute(Sql)
 ...
 Do While Not rsIndex.EOF
	...
	PrintStepInfo strSerialNumber, strPartNumber, strFamily
	rsIndex.MoveNext
Loop
...
Do While Not rsG3BurnIN.EOF
	...
	Response.Write "<tr>"
		Response.Write "<td width=130><b>" &  "Burn-In Time"    & "</b></td>"
		Response.Write "<td width=130><b>" &  "G3   "     & "</b></td>"
		Response.Write "<td width=130><b>" &  rsG3BurnIN("SerialNumber")    & "</b></td>"
		Response.Write "<td width=130><b>" &  rsG3BurnIN("UnitType")    & "</b></td>"
...
'----------------------------------------------------------------------------------------------------
Sub PrintStepInfo (UnitSerialNumber, UnitPartNumber, UnitFamily)
	...
	Response.Write "<tr>"
				...
				'Response.Write "<td>&nbsp;</td><td>&nbsp;</td><td valign='top'>" & sMeasure & "</td>"
					...
					Response.Write "<td width=130><b>" &  tsLabel    & "</b></td>"
					Response.Write "<td width=130><b>" &  UnitFamily    & "</b></td>"
					Response.Write "<td width=130><b>" &  UnitSerialNumber    & "</b></td>"
					Response.Write "<td width=130><b>" &  UnitPartNumber    & "</b></td>"
...
Sub PrintStepHeaderInfo
	...
	Response.Write "<tr>"
		Response.Write "<td width=130><b>Step Name</b></td>"
		Response.Write "<td width=130><b>Family</b></td>"
		Response.Write "<td width=130><b>Serial Number</b></td>"
		Response.Write "<td width=130><b>Part Number</b></td>"
