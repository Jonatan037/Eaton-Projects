...
sTestStep = Split("Battery Mode Test(No Load)", ",")
...
Sql = "SELECT I.DBID, I.PartNumber, I.SerialNumber, I.Sequence, I.StartTime, I.TestResult, I.ComputerName, I.ResultsID, P.Family, P.Category " & _
      ...
      "WHERE " & _
         "I.RecordType = 2 AND I.DBID = 2 AND P.Family = 'TAA' AND P.Category = '5130' AND I.Sequence = 1 AND I.TestResult = 'Pass' AND " & _
