...
sTestStep = Split("Battery Mode R Load test", ",")
...
Sql = "SELECT I.DBID, I.PartNumber, I.SerialNumber, I.Sequence, I.StartTime, I.TestResult, I.ComputerName, I.ResultsID, P.Family, P.Category " & _
      ...
      "WHERE " & _
         "I.RecordType = 2 AND I.DBID = 2 AND P.Family = 'TAA' AND P.Category = '9130' AND I.Sequence = 1 AND I.TestResult = 'Pass' AND " & _
	...
	With rsTestResults
		...
		Do Until .EOF
			...
			If blnGetData Then
				...
				If  Right(rdLabel,7) = "Voltage" OR Right(rdLabel,9) = "Frequency" Then
