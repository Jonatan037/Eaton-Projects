...
<head>
<title>9355-30 Process Capability</title>
</head>
...
sTestStep = Split("Collect MSA Data", ",")
	...
	With rsTestResults
		...
		Do Until .EOF
			...
			If blnGetData Then
				...
				'If using MSA data for the Cpk, then only include the first 6 rows of data for each serial number.
				'rsIndex("SerialNumber")
