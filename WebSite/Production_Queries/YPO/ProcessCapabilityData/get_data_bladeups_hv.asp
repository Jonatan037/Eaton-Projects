...
sTestStep = Split("On-Line Out Frequency,HV Inverter V Cal verfy", ",")
...
Sql = "SELECT I.DBID, I.PartNumber, I.SerialNumber, I.Sequence, I.StartTime, I.TestResult, I.ComputerName, I.ResultsID, P.Family, P.Category " & _
      ...
      "WHERE " & _
         "I.RecordType = 2 AND I.DBID = 2 AND P.Family = 'BLADEUPS' AND P.PartNumber LIKE 'ZC__2%' AND I.Sequence = 1 AND I.TestResult = 'Pass' AND " & _
