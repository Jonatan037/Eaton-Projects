...
Select Case RecordType
	...
	'Panda Premiere "Production" on Raleigh TDM
	Case 23

		Response.Redirect "http://ra1ncstdm02/TDM/AdHocReport/ViewAdHocReport.aspx"


	'Panda Premiere "Engineering Evaluation" on Raleigh TDM
	Case 26

		Response.Redirect "get_report_011_93PM_engineering_evaluation.asp?ID=" & IndexID
