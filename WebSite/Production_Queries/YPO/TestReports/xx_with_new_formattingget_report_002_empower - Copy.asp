...
'			sActual = Format$(.Fields("Actual" ), sFormat)
	...
	'If Left(sMin, 8) = "TxD = \x" Then sMin = "TxD = "
...
Sub PrintStepInfo
    ...
    Const WIDTH_STEP    = "width=5%"
    Const WIDTH_ID      = "width=5%"
    Const WIDTH_TEST    = "width=25%"
    Const WIDTH_MINIMUM = "width=15%"
    Const WIDTH_ACTUAL  = "width=15%"
    Const WIDTH_MAXIMUM = "width=15%"
    Const WIDTH_RESULT  = "width=5%"

    Const WIDTH_TABLE   = "width=95%"
	...
	Response.Write "<table  " & WIDTH_TABLE & " cellspacing=0 cellpadding=2 border=0>"

	Response.Write "<tr>"
		Response.Write "<td " & WIDTH_STEP      & "><b>Step</b></td>"
		Response.Write "<td " & WIDTH_ID      & "><b>ID</b></td>"
		Response.Write "<td " & WIDTH_TEST    & "><b>Test</b></td>"
		Response.Write "<td " & WIDTH_MINIMUM & "><b>Minimum</b></td>"
		Response.Write "<td " & WIDTH_ACTUAL  & "><b>Actual</b></td>"
		Response.Write "<td " & WIDTH_MAXIMUM & "><b>Maximum</b></td>"
		Response.Write "<td " & WIDTH_RESULT  & "><b>Result</b></td>"
	Response.Write "</tr>"
