...
<form>
  ...
  <select  SIZE="1" NAME="QuerySelection">
    ...
    <option value="ypo\show_empower_test_logs.asp">Show Test Log</option>
	...
	<option value="ypo\ProcessCapabilityData\get_data_9395.asp">Process Capability Data - 9395</option>
	<option value="ypo\ProcessCapabilityData\get_data_9390.asp">Process Capability Data - 9390</option>
	<option value="ypo\ProcessCapabilityData\get_data_93PM.asp">Process Capability Data - 93PM</option>
	<option value="ypo\ProcessCapabilityData\get_data_93PM-L.asp">Process Capability Data - 93PM-L</option>
    ...
    <option>--------------------------------------------------------------------------------</option>
    <option value="ypo\CPO_BatteryLine\GetTestData.asp"> CPO Battery Line Test Data </option>
