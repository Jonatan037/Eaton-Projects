...
<h2 align="center"><!--mstheme--><font color="#CC6666">CPO Database Query Template<!--mstheme--></font></h2>
...
<p><%
	...
	Query = "SELECT PartNumber, TestFailed, Count(TestFailed) As Count " & _
			 "FROM Index " & _
			 "WHERE (Seq = 1) AND " & _
			 "(Results = 0) AND " & _
			 ...
			 "GROUP BY PartNumber, TestFailed " & _
			 "ORDER BY PartNumber, Count(TestFailed) DESC"
	'--------------------------------------------------------------------------------------------------------
