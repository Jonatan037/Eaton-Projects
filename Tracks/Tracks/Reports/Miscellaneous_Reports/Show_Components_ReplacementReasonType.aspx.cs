...
public partial class Tracks_Reports_Miscellaneous_Reports_Show_Components_ReplacementReasonType : System.Web.UI.Page
{
    // ViewState names   
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string sql = "SELECT ACTIVE, ID, DESCRIPTION FROM COMPONENTS_CT_REPLACEMENT_REASON_TYPE";
    ...
    protected void btnDownload_Click(object sender, EventArgs e)
    {
        ...
        string filename = "COMPONENTS_CT_REPLACEMENT_REASON_TYPE";
