...
public partial class Tracks_Reports_Miscellaneous_Reports_Show_LaborHoursTypes : System.Web.UI.Page
{
    // ViewState names   
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string sql = "SELECT ACTIVE, ID, DESCRIPTION, HOURLY_RATE FROM LABOR_HOURS_CT_LABOR_TYPE";
    ...
    protected void btnDownload_Click(object sender, EventArgs e)
    {
        ...
        string filename = "LABOR_HOURS_CT_LABOR_TYPE";
