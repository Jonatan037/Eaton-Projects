...
namespace Tracks.DAL
{
    ...
    public class ATE
    {
        ...
        public void Add(string SerialNumber, string PartNumber, string TimeStamp, string PassedTest, string EmployeeID, string RecordType, string ProgramName = "")
        {
            ...
            // Some of the YPO test use -1 to indicate true, rather than 1.
            PassedTest = PassedTest.Replace("-", "");
            ...
            // Only allow serial numbers starting with 
            if (FirstChar == "E") return;

            // Get rid of _Assembly_Test tag for RPO.
            //if (FirstChar == "E" && SerialNumber.Length >= 10)
            //{
