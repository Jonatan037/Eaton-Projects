<%@ Page Title="Calibration Log Details" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="CalibrationDetails.aspx.cs" Inherits="TED_CalibrationDetails" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <style>
        ...
        .searchable-list {
            ...
            display: none;
            margin-top: 2px;
            box-shadow: 0 8px 32px rgba(0,0,0,.12), 0 0 0 1px rgba(255,255,255,.05);
        ...
        .form-group textarea.readonly-field { opacity:0.6; cursor:not-allowed; background:rgba(0,0,0,.08); }
        ...
        html.theme-light .form-group input[readonly],
        html.theme-light .form-group textarea[readonly],
        html.theme-light .form-group input.readonly-field,
        html.theme-light .form-group textarea.readonly-field { background:rgba(0,0,0,.04); }
        ...
        /* Calibration selector dropdown - Orange/Blue theme */
        .calibration-selector { min-width:240px; }
        .calibration-selector select { 
            width:100%; 
            padding:10px 12px; 
            border-radius:12px; 
            border:1px solid rgba(251,146,60,.35); 
            background:linear-gradient(155deg, rgba(251,146,60,.18), rgba(249,115,22,.12)); 
            color:inherit; 
            font-size:13px; 
            font-family:inherit; 
            box-sizing:border-box;
            font-weight:600;
            box-shadow:0 2px 8px rgba(251,146,60,.15);
        }
        .calibration-selector select option {
            background:#1f242b;
            color:#e2e8f0;
            padding:8px;
        }
        .calibration-selector select:focus { 
            outline:none; 
            border-color:rgba(251,146,60,.6); 
            box-shadow:0 0 0 3px rgba(251,146,60,.2), 0 2px 8px rgba(251,146,60,.25); 
        }
        html.theme-light .calibration-selector select, html[data-theme='light'] .calibration-selector select { 
            background:linear-gradient(155deg, #fed7aa, #fde68a); 
            border:1px solid rgba(251,146,60,.4); 
            color:#c2410c; 
            box-shadow:0 2px 6px rgba(251,146,60,.2);
        }
        html.theme-light .calibration-selector select option, html[data-theme='light'] .calibration-selector select option {
            background:#ffffff;
            color:#333333;
        }
        html.theme-light .calibration-selector select:focus, html[data-theme='light'] .calibration-selector select:focus { 
            border-color:rgba(234,88,12,.6); 
            box-shadow:0 0 0 3px rgba(251,146,60,.15), 0 2px 8px rgba(251,146,60,.3); 
        }

        /* Calibration selector searchable input styling */
        .calibration-selector .searchable-input {
            width: 100% !important;
            padding: 10px 12px !important;
            border-radius: 12px !important;
            border: 1px solid rgba(251,146,60,.35) !important;
            background: linear-gradient(155deg, rgba(251,146,60,.18), rgba(249,115,22,.12)) !important;
            color: inherit !important;
            font-size: 13px !important;
            font-family: inherit !important;
            box-sizing: border-box !important;
            font-weight: 600 !important;
            box-shadow: 0 2px 8px rgba(251,146,60,.15) !important;
            min-width: 600px !important;
        }

        .calibration-selector .searchable-input:focus {
            outline: none !important;
            border-color: rgba(251,146,60,.6) !important;
            box-shadow: 0 0 0 3px rgba(251,146,60,.2), 0 2px 8px rgba(251,146,60,.25) !important;
        }

        html.theme-light .calibration-selector .searchable-input,
        html[data-theme='light'] .calibration-selector .searchable-input {
            background: linear-gradient(155deg, #fed7aa, #fde68a) !important;
            border: 1px solid rgba(251,146,60,.4) !important;
            color: #c2410c !important;
            box-shadow: 0 2px 6px rgba(251,146,60,.2) !important;
        }

        html.theme-light .calibration-selector .searchable-input:focus,
        html[data-theme='light'] .calibration-selector .searchable-input:focus {
            border-color: rgba(234,88,12,.6) !important;
            box-shadow: 0 0 0 3px rgba(251,146,60,.15), 0 2px 8px rgba(251,146,60,.3) !important;
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="admin-grid">
        <!-- Sidebar -->
        <aside class="sidebar" role="navigation" aria-label="Calibration sidebar">
            <nav>
                <div class="sidebar-title">CALIBRATION LOG</div>
                
                <div class="sidebar-header">Details</div>
                <ul class="sidebar-nav">
                    <li>
                        <%
                            string detailsHref = "CalibrationDetails.aspx?action=viewFirst";
                        ...
                        <a href="<%= detailsHref %>" class="<%= Request.QueryString["mode"] != "new" && !string.IsNullOrEmpty(Request.QueryString["id"]) ? "active" : "" %>">
                            ...
                            <span>Calibration Log Details</span>
                        </a>
                    </li>
                </ul>
                ...
                <ul class="sidebar-nav">
                    <li>
                        <a href="CalibrationDetails.aspx?mode=new" class="<%= Request.QueryString["mode"] == "new" ? "active" : "" %>">
                ...
                <ul class="sidebar-nav">
                    <li>
                        <a href="CalibrationDashboard.aspx" class="danger">
                            ...
                            <span>Back to Calibration Dashboard</span>
                        </a>
                    </li>
                </ul>
            </nav>
            ...
            <div class="admin-form">
                <div class="page-header">
                    <div class="page-header-left">
                        <h1><asp:Literal ID="litPageTitle" runat="server" Text="Calibration Log Details" /></h1>
                        <div class="subtitle"><asp:Literal ID="litPageSubtitle" runat="server" Text="View and edit equipment calibration log information" /></div>
                    </div>
                    <div class="calibration-selector searchable-dropdown" runat="server" id="divCalibrationSelector" visible="false">
                        <asp:DropDownList ID="ddlCalibrationSelector" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlCalibrationSelector_SelectedIndexChanged" />
                    </div>
                </div>
                
                <asp:PlaceHolder ID="phMessage" runat="server" Visible="false">
                    <div style="padding:12px; background:rgba(34,197,94,.15); border:1px solid rgba(34,197,94,.25); border-radius:10px; margin-bottom:20px; color:#86efac;">
                ...
                <div class="form-grid">
                    <div class="span-4">
                        <div class="form-group">
                            <label for="txtID">Calibration Log ID</label>
                    ...
                    <div class="span-8">
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="ddlEquipmentID" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlEquipmentID_SelectedIndexChanged" EnableViewState="true">
                    ...
                    <div class="span-4">
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtEquipmentType" runat="server" ReadOnly="true" EnableViewState="true" CssClass="readonly-field" />
                        </div>
                    </div>
                    <div class="span-4">
                        <div class="form-group">
                            <label for="txtCalibrationFrequency">Calibration Frequency</label>
                            <asp:TextBox ID="txtCalibrationFrequency" runat="server" ReadOnly="true" EnableViewState="true" CssClass="readonly-field" />
                        </div>
                    </div>
                    <div class="span-4">
                        <div class="form-group">
                            <label for="txtLastCalibration">Last Calibration</label>
                            <asp:TextBox ID="txtLastCalibration" runat="server" ReadOnly="true" EnableViewState="true" CssClass="readonly-field" />
                        </div>
                    </div>
                    <div class="span-4">
                        <div class="form-group">
                            <label for="txtLastCalibratedBy">Last Calibrated By</label>
                            <asp:TextBox ID="txtLastCalibratedBy" runat="server" ReadOnly="true" EnableViewState="true" CssClass="readonly-field" />
                        </div>
                    </div>
                    <div class="span-4">
                        <div class="form-group">
                            <label for="txtNextCalibration">Next Calibration</label>
                            <asp:TextBox ID="txtNextCalibration" runat="server" ReadOnly="true" EnableViewState="true" CssClass="readonly-field" />
                        </div>
                    </div>
                    <div class="span-4">
                        <div class="form-group">
                            <label for="txtLocation">Location</label>
                            <asp:TextBox ID="txtLocation" runat="server" ReadOnly="true" EnableViewState="true" CssClass="readonly-field" />
                        </div>
                    </div>
                    <div class="span-4">
                        <div class="form-group">
                            <label for="txtCalibrationEstimatedTime">Est. Calibration Time (hrs)</label>
                            <asp:TextBox ID="txtCalibrationEstimatedTime" runat="server" ReadOnly="true" EnableViewState="true" CssClass="readonly-field" placeholder="e.g., 2.5" />
                        </div>
                    </div>
                </div>
                ...
                <div class="form-grid">
                    <div class="span-4">
                        <div class="form-group">
                            <label for="ddlMethod">Method <span style="color:#f87171;">*</span></label>
                    ...
                    <div class="span-4">
                        <div class="form-group">
                            <label for="txtStartDate">Start Date <span style="color:#f87171;">*</span></label>
                            <asp:TextBox ID="txtStartDate" runat="server" TextMode="Date" />
                        </div>
                    </div>
                    <div class="span-4" id="divSentOutDate" runat="server" visible="false">
                        <div class="form-group">
                            <label for="txtSentOutDate">Sent Out Date <span style="color:#f87171;">*</span></label>
                            <asp:TextBox ID="txtSentOutDate" runat="server" TextMode="Date" />
                        </div>
                    </div>
                    <div class="span-4" id="divReceivedDate" runat="server" visible="false">
                        <div class="form-group">
                            <label for="txtReceivedDate">Received Date <span style="color:#f87171;">*</span></label>
                            <asp:TextBox ID="txtReceivedDate" runat="server" TextMode="Date" />
                        </div>
                    </div>
                    <div class="span-4">
                        <div class="form-group">
                            <label for="txtCompletedDate">Completed Date <span style="color:#f87171;">*</span></label>
                            <asp:TextBox ID="txtCompletedDate" runat="server" TextMode="Date" />
                        </div>
                    </div>
                    <div class="span-4">
                        <div class="form-group">
                            <label for="txtNextCalibrationDate">Next Calibration <span style="color:#f87171;">*</span></label>
                            <asp:TextBox ID="txtNextCalibrationDate" runat="server" TextMode="Date" />
                        </div>
                    </div>
                    <div class="span-4" id="divPerformedBy" runat="server">
                        <div class="form-group">
                            <label for="ddlPerformedBy">Calibrated By <span style="color:#f87171;">*</span></label>
                            <asp:DropDownList ID="ddlPerformedBy" runat="server">
                                    <asp:ListItem Value="" Text=" " />
                            </asp:DropDownList>
                        </div>
                    </div>
                    <div class="span-4" id="divVendorName" runat="server" visible="false">
                        <div class="form-group">
                            <label for="txtVendorName">Vendor Name <span style="color:#f87171;">*</span></label>
                            <asp:TextBox ID="txtVendorName" runat="server" placeholder="External vendor name..." />
                        </div>
                    </div>
                    <div class="span-4">
                        <div class="form-group">
                    ...
                    <div class="span-4">
                        <div class="form-group">
                            <label for="txtCalibrationCertificate">Certificate # <span style="color:#f87171;">*</span></label>
                            <asp:TextBox ID="txtCalibrationCertificate" runat="server" placeholder="Certificate number..." />
                        </div>
                    </div>
                    <div class="span-4">
                        <div class="form-group" data-optional="true">
                            <label for="txtCalibrationStandard">Calibration Standard</label>
                            <asp:TextBox ID="txtCalibrationStandard" runat="server" placeholder="e.g., ISO/IEC 17025" />
                        </div>
                    </div>
                    <div class="span-4">
                        <div class="form-group">
                            <label for="ddlResultCode">Result Code <span style="color:#f87171;">*</span></label>
                            <asp:DropDownList ID="ddlResultCode" runat="server">
                                    <asp:ListItem Value="" Text=" " />
                                <asp:ListItem Value="Pass" Text="Pass" />
                                <asp:ListItem Value="Fail" Text="Fail" />
                                <asp:ListItem Value="OOT" Text="Out of Tolerance (OOT)" />
                                <asp:ListItem Value="Adjusted" Text="Pass with Adjustments" />
                            </asp:DropDownList>
                        </div>
                    </div>
                    <div class="span-4">
                    ...
                    <div class="span-12">
                        <div class="form-group">
                            <label for="txtCalibrationResults">Calibration Results <span style="color:#f87171;">*</span></label>
                            <asp:TextBox ID="txtCalibrationResults" runat="server" TextMode="MultiLine" placeholder="Detailed calibration measurements and results..." />
                        </div>
                    </div>
                </div>
